...
public class EvilEnem : MonoBehaviour
...

{
    ...
    void Update()
    {
        ...
        RaycastHit2D hit;
        hit = Physics2D.Raycast(transform.position + Vector3.left, Vector2.left,100f, aliadoLayer);
        ...
        RaycastHit2D hit2;
        hit2 = Physics2D.Raycast(transform.position + Vector3.left, Vector2.left, 100f, aliadoLayer);
    ...
    public void lunchEvil()
    {
            ...
            GameObject.Instantiate(enimgo_prefab, new Vector3(52.8f, -20.52f, -64.91f), transform.rotation);
