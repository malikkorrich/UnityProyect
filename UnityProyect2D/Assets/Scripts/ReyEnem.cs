...
public class ReyEnem : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        RaycastHit2D hit2;
        hit2 = Physics2D.Raycast(transform.position + Vector3.left, Vector2.left, 250f, personajeLayer);
    ...
    public void lunchRey()
    {
            ...
            GameObject.Instantiate(rey_prefab, new Vector3(52.8f, -21.64f, -64.91f), transform.rotation);
